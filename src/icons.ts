...
export const icons = {
 ...
 'bars-solid': lazy(() => import('@/assets/icons/bars-solid.svg')),
 ...
 'chevron-down-solid': lazy(() => import('@/assets/icons/chevron-down-solid.svg')),
 'circle-check-solid': lazy(() => import('@/assets/icons/circle-check-solid.svg')),
 'circle-exclamation-solid': lazy(() => import('@/assets/icons/circle-exclamation-solid.svg')),
 'circle-info-solid': lazy(() => import('@/assets/icons/circle-info-solid.svg')),
 'credit-card-solid': lazy(() => import('@/assets/icons/credit-card-solid.svg')),
 'face-smile-regular': lazy(() => import('@/assets/icons/face-smile-regular.svg')),
 'gear-solid': lazy(() => import('@/assets/icons/gear-solid.svg')),
 'google': lazy(() => import('@/assets/icons/google.svg')),
 'mask-solid': lazy(() => import('@/assets/icons/mask-solid.svg')),
